...
<head>
  <meta charset="UTF-8">
  <title>Apple Watch Series 9 - TechBay SG</title>
    ...
    <div class="maincontent product-detail">
      ...
      <div class="product-detail-box">
        ...
        <div class="product-image">
          <img src="../images/applewatch.webp" alt="Apple Watch Series 9">
        </div>

        <!-- Product Info -->
        <div class="product-info-detail">
          <h2>Apple Watch Series 9 (GPS, 41mm Aluminium Case)</h2>
          <p><strong>Brand:</strong> Apple</p>
          <div class="rating">⭐⭐⭐⭐⭐ (102)</div>

          <p class="price"><span class="old-price">€570</span> €400</p>
      ...
      <div class="product-tabs">
        <h3>Description</h3>
        <p>The Apple Watch Series 9 is your ultimate fitness companion with GPS tracking, health monitoring, and seamless integration with your iPhone. Designed with a lightweight aluminium case and Retina display, it combines style and performance in one sleek device.</p>
